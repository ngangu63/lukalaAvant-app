...
export class BigPictureService {
  ...
  private bigPictures: BigPicture[] = [
    ...
    { name: 'Andre Kinsonas', role: '', location: 'DR Congo', imageUrl: 'assets/images/membres/AndreKinsona.jpeg', gender: 1, defaultImage: 'assets/images/Remy_Cravate1.jpg', profession: '', message: '', LinkedIn: '' },
