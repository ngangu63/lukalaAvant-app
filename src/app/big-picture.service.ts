...
export class BigPictureService {
  ...
  private bigPictures: BigPicture[] = [
    ...
    { name: 'Rémy Miantezila', role: 'Conseiller , Webmaster ; ', location: 'États-Unis', imageUrl: 'assets/images/Remy_Cravate1.jpg', gender: 1, defaultImage: 'assets/images/Remy_Cravate1.jpg', profession: 'Software Engineer', message: 'Sending love to all of you!', LinkedIn: 'https://www.linkedin.com/in/remy-miantezila-miabwa/' },
    ...
    { name: 'Josky Wasukama ', role: 'Conseiller , ', location: 'France', imageUrl: 'assets/images/dirigeants/MasukalaJosky.jpeg', gender: 1, defaultImage: 'assets/images/Remy_Cravate1.jpg', profession: '', message: '', LinkedIn: '' },
    { name: 'Coco Mitouche', role: 'Commissaire aux comptes , ', location: 'France', imageUrl: 'assets/images/dirigeants/Mitouche.jpeg', gender: 1, defaultImage: 'assets/images/Remy_Cravate1.jpg', profession: '', message: '', LinkedIn: '' },
